    ...
    .directive('angucomplete', function($parse, $http, $sce, $timeout) {
        return {
            ...
            link: function($scope, elem, attrs) {
                ...
                $scope.$watch('searchStr', function(value) {
                    (value != null && value == '') && $scope.onChange({result: {originalObject: {uri: ''}}});
                });
